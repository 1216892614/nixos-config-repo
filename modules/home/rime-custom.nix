# Rime 自定义配置 + fcitx5 Moss & Fern 主题
...
in
{
  # ── fcitx5 主题（Moss & Fern 配色）────────────────────────────
  # 主题文件 → ~/.local/share/fcitx5/themes/MossFern/theme.conf
  xdg.dataFile."fcitx5/themes/MossFern/theme.conf".source = ./fcitx5-theme-moss-fern.conf;

  # ClassicUI 配置：选用主题 + 竖排候选 + 光标跟随
